...
public static class Poly2Mesh
{
    ...
    /// <param name="material">Material to assign to the new GameObject.</param>
    public static GameObject CreateGameObject(Polygon polygon, string name = "Polygon", Material material = null)
    {
